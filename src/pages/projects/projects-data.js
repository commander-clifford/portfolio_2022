        ...
        {projectsData.map((data, i) => {
          return (
            <li key={i} id={data?.fields?.slug} className="project-data-item">
              ...
              <img width="100" height="auto" src={data?.fields?.heroImage?.fields?.file?.url} />
              ...
              <ul>
                ...
                {data?.fields?.liveUrl ? <li><a target="_blank" href={data?.fields?.liveUrl}>{data?.fields?.liveUrl}</a></li> : null}
                {data?.fields?.githubUrl ? <li><a target="_blank" href={data?.fields?.githubUrl}>{data?.fields?.githubUrl}</a></li> : null}
                {data?.fields?.codepenUrl ? <li><a target="_blank" href={data?.fields?.codepenUrl}>{data?.fields?.codepenUrl}</a></li> : null}
